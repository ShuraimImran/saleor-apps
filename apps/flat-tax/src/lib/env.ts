...
export const env = createEnv({
  ...
  server: {
    ...
    MANIFEST_APP_ID: z.string().optional().default("saleor.app.flat-tax"),
    OTEL_ACCESS_TOKEN: z.string().optional(),
    OTEL_ENABLED: booleanSchema.optional().default("false"),
    OTEL_SERVICE_NAME: z.string().optional().default("saleor-app-flat-tax"),
    ...
    APP_NAME: z.string().optional().default("FlatTax"),
  },
  shared: {
